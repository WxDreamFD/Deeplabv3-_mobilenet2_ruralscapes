...
def compute_mIoU(gt_dir, pred_dir, png_name_list, num_classes, name_classes=None, remove_classes=None):  
    ...
    if remove_classes != None:
        hist = np.delete(hist, remove_classes, 0)
        hist = np.delete(hist, remove_classes, 1)
    # print("===> hist: {}".format(hist))
